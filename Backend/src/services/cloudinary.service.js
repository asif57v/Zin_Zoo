...
export const buildRawDownloadUrlFromFileUrl = (fileUrl, options = {}) => {
    ...
    // Raw uploads in Cloudinary always include the file extension in their public ID.
    // Therefore, we must use exactPublicId (which preserves the extension) to sign the download URL correctly.
    const publicId = exactPublicId || normalizedPublicId;
