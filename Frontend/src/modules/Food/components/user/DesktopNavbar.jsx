...
export default function DesktopNavbar({ showLogo = true }) {
    ...
    const isDelivery = !isDining && !isUnder250 && !isProfile && !isServices && (location.pathname === "/food/user" || location.pathname === "/food" || (location.pathname.startsWith("/food/user") && !location.pathname.includes("/dining") && !location.pathname.includes("/under-250") && !location.pathname.includes("/services") && !location.pathname.includes("/profile")))
    const isBannerRoute =
